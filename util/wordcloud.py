...
def wordcloud(input_data):
  data = pd.read_csv(r".\data\craw_data"'\\' + input_data + '.csv') 
...
def wordcloud_index(input_data):
  data = pd.read_csv(r".\data"'\\' + input_data + '.csv') 
...
def wordclouod_word_index(input_data):

  list = wordcloud_index(input_data)
  wordcolud_list = []
